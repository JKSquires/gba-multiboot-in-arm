...
Step one in this method is optional, but highly recommended. If step one is skipped, the client program will be loaded on the client but not will not run (the Nintendo logo will be garbled).
